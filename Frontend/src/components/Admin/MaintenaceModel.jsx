...
const MaintenaceModel = ({ open, setOpen }) => {
  return (
    <>
      {open && (
        <div className="absolute z-50 flex flex-col items-center justify-center top-0 h-full pt-4 bg-gray-300 w-full">
          <div
...
export default MaintenaceModel;
